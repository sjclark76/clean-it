                ...
                {isBookingSuccessful ? (
                  ...
                  <div className='text-center'>
                    ...
                    <p className='text-gray-700 text-lg mb-6'>
                      Thank you for your request. Jessiah will contact you
                  ...
                  <>
                    <div className='text-center mb-8'>
                      ...
                      <p className='text-gray-600 text-lg'>
                        Fill out the form below and select an available 2-hour
                        slot to request an appointment.
                      </p>
                    </div>
                    ...
                    <p className='text-center text-gray-600 mt-8 text-sm'>
                      Please note: This is a request. Your appointment is
                      confirmed once Jessiah contacts you.
                    </p>
                  </>
                )}
              </div>
